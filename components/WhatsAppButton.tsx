...
import { MessageCircle } from "lucide-react" // Fallback if no SVG
import { useEffect, useState } from "react"

export function WhatsAppButton() {
    const phoneNumber = "967700400075"
    const message = "Hello, I need help with Movix delivery." // Optional pre-filled message

    // Check if mobile to decide behavior, or just handle in click
    ...
    return (
        <a
            ...
            title="Help Center / خدمة العملاء"
        >
            {/* WhatsApp SVG Icon */}
